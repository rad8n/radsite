...
function resolveConfigPath() {
    ...
    if (fs.existsSync(legacyPluginsJsonPath))
        return legacyPluginsJsonPath;
    if (fs.existsSync(defaultConfigYamlPath))
        return defaultConfigYamlPath;
    if (fs.existsSync(legacyDefaultPluginsJsonPath))
        return legacyDefaultPluginsJsonPath;
    return configYamlPath;
}
